...
export default function AdminParents() {
  ...
  const [form, setForm] = useState({
    ...
    studentName:"", studentId:"", linkedStudentId:"",
  });
        ...
        {showForm && (
          <div className="form-card">
                ...
                <select
                  ...
                  {students.map(s => (
                    <option key={s._id} value={s._id}>
                      ...
                      {s.hostelRoom ? ` — Room ${s.hostelRoom}` : ""}
                    </option>
                  ))}
                </select>
              )}
              ...
              {[
                ...
                <div key={f.k}>
                  ...
                  <input type={f.type} value={form[f.k]}
                    ...
                    onFocus={() => ff(f.k)} onBlur={() => fbl(f.k)}
                    style={inputSt(formFocus[f.k])}/>
                </div>
              ))}
              <div>
            ...
            <div style={{ display:"flex", gap:10, marginTop:20, justifyContent:"flex-end" }}>
              <button
                onClick={() => { setShowForm(false); setForm({ name:"", email:"", phone:"", relation:"Father", studentName:"", studentId:"", linkedStudentId:"" }); }}
